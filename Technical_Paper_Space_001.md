...
ハッキングは単なるコードの問題ではなく、心理の問題であることが多い。多くの攻撃者は、自分自身の内面的な不安定さを埋め合わせるために「支配」を求める。彼らが環境をコントロールしようとするのは、彼ら自身をコントロールできていないからだ。悪意が弱さの副産物（ふくさんぶつ）であることを理解することで、恐怖の状態から、冷静で客観的な分析の状態へと切り替えることができる。見ているのは怪物ではなく、緩和（ミティゲーション）できる「欠陥（けっかん）のあるロジック」だ。
